...
ActiveRecord::Schema.define(version: 20170521152619) do
  ...
  create_table "music_importers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "songs", force: :cascade do |t|
    ...
    t.integer  "album_cover_id", default: 1
    t.text     "lyrics",         default: "No lyrics available."
  end
